...
| landscape | what options even exist | delegate to the `afk:research` skill |
| mixed | discover options, then commit to one | **sequential**: `afk:research` first to shortlist, *then* doc-verify the choice |
