...
the observed behavior actually delivers them. A clean SHIP requires both: it
...
- [qa](/reference/qa) — evidence-backed QA that judges product intent, not just execution
