...
// condition, shaped then checked against the quality criteria.
const scene: Scene = {
  width: 880,
  height: 300,
  nodes: [
    ...
    { id: 'check', x: 508, y: 96, w: 184, h: 96, shape: 'diamond', fontSize: 14, label: 'criteria pass?' },
...
<RoughDiagram :scene="scene" caption="write-good-goal turns vague intent into a single agent-evaluable completion condition — shaped, then checked against the quality criteria." />
...
- Checks the result against three quality criteria: specific (names the thing to change or verify), measurable (has a test, command, metric, artifact, or checklist), and non-ambiguous (avoids words like "better", "clean", or "done").
