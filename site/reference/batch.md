...
const scene: Scene = {
  ...
  nodes: [
    ...
    { id: 'fallback', x: 190, y: 50, w: 170, h: 50, shape: 'round', fontSize: 12, label: '→ afk:implement' },
    { id: 'decompose', x: 190, y: 164, w: 170, h: 60, shape: 'round', accent: true, label: 'decompose', sub: 'independent units' },
    { id: 'u1', x: 430, y: 50, w: 180, h: 50, shape: 'round', fontSize: 12, label: 'unit 1 worker' },
    { id: 'u2', x: 430, y: 128, w: 180, h: 50, shape: 'round', fontSize: 12, label: 'unit 2 worker' },
    { id: 'u3', x: 430, y: 206, w: 180, h: 50, shape: 'round', fontSize: 12, label: 'unit 3 worker' },
    { id: 'u4', x: 430, y: 284, w: 180, h: 50, shape: 'round', fontSize: 12, label: 'unit 4 worker' },
