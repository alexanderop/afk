...
const scene: Scene = {
  ...
  nodes: [
    { id: 'brain', x: 40, y: 52, w: 170, h: 46, shape: 'round', fontSize: 13, label: 'brain/ ?' },
    { id: 'plans', x: 40, y: 110, w: 170, h: 46, shape: 'round', fontSize: 13, label: 'brain/plans' },
    { id: 'diff', x: 40, y: 168, w: 170, h: 46, shape: 'round', fontSize: 13, label: 'git status' },
    { id: 'qa', x: 40, y: 226, w: 170, h: 46, shape: 'round', fontSize: 13, label: 'qa reports' },
    { id: 'catalog', x: 40, y: 284, w: 170, h: 46, shape: 'round', fontSize: 13, label: 'skill catalog' },
