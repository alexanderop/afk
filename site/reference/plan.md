...
const scene: Scene = {
  ...
  nodes: [
    ...
    { id: 'brain', x: 20, y: 150, w: 150, h: 58, shape: 'cylinder', accent: true, fontSize: 13, label: 'brain principles' },
    { id: 'plan', x: 230, y: 92, w: 160, h: 62, shape: 'round', accent: true, label: 'plan', sub: 'phases, ordered' },
    { id: 'explore', x: 230, y: 230, w: 160, h: 54, shape: 'round', fontSize: 13, label: 'explore subagents' },
    { id: 'overview', x: 478, y: 52, w: 260, h: 48, shape: 'round', accent: true, fontSize: 13, label: 'overview.md' },
    { id: 'p1', x: 478, y: 120, w: 260, h: 44, shape: 'round', fontSize: 13, label: '01 · phase' },
    { id: 'p2', x: 478, y: 180, w: 260, h: 44, shape: 'round', fontSize: 13, label: '02 · phase' },
    { id: 'p3', x: 478, y: 240, w: 260, h: 44, shape: 'round', fontSize: 13, label: '03 · phase' },
  ],
  edges: [
    { from: 'task', to: 'plan' },
