...
- Creates (only if missing): `brain/`, `brain/index.md`, `brain/principles.md`, `brain/principles/`, `brain/codebase.md`, `brain/codebase/`, `brain/plans/`, and `brain/plans/index.md`.
