...
- Filters aggressively: recurring patterns beat one-off incidents; 3 high-signal findings beat 9 noisy ones.
- Proposes changes in a table (finding, frequency/evidence, proposed action) — the user decides what to apply.
- Skill-specific learnings are routed into the relevant SKILL.md; brain updates follow the `afk:brain` writing conventions.
