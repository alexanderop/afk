...
const scene: Scene = {
  ...
  nodes: [
    { id: 'history', x: 20, y: 40, w: 176, h: 60, shape: 'cylinder', accent: true, fontSize: 13, label: '~/.claude/projects' },
    { id: 'brain', x: 20, y: 200, w: 176, h: 58, shape: 'cylinder', accent: true, fontSize: 13, label: 'existing brain' },
    { id: 'a1', x: 260, y: 52, w: 220, h: 52, shape: 'round', fontSize: 14, label: 'batch 1' },
    { id: 'a2', x: 260, y: 124, w: 220, h: 52, shape: 'round', fontSize: 14, label: 'batch 2' },
    { id: 'a3', x: 260, y: 196, w: 220, h: 52, shape: 'round', fontSize: 14, label: 'batch 3' },
    { id: 'a4', x: 260, y: 268, w: 220, h: 52, shape: 'round', fontSize: 14, label: 'batch 4' },
    { id: 'synth', x: 560, y: 130, w: 170, h: 64, shape: 'round', accent: true, label: 'synthesize', sub: 'dedupe + filter' },
    { id: 'write', x: 790, y: 130, w: 170, h: 58, shape: 'cylinder', accent: true, fontSize: 13, label: 'brain + SKILL.md' },
  ],
  edges: [
    ...
    {
      from: 'brain', to: 'synth', fromSide: 'bottom', toSide: 'bottom',
      via: [{ x: 230, y: 336 }, { x: 560, y: 336 }], label: 'context', labelAt: { x: 388, y: 336 },
    },
